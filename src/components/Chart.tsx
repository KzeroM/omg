...
/** �ǽð� ��Ʈ - play_count ��� (React Query ĳ��, Supabase �ǽð� ����) */
  ...
  return (
    <section id="chart" className="rounded-2xl bg-[var(--color-bg-surface)] p-6 ring-1 ring-[var(--color-border)]">
      <div className="mb-4 flex items-center justify-between">
        <h2 className="text-lg font-bold text-[var(--color-text-primary)]">�ǽð� TOP {limit} ��Ʈ</h2>
        {live && (
      ...
      {tracks.length === 0 ? (
        <div className="rounded-xl border border-dashed border-[var(--color-border)] py-12 text-center">
          ...
          <p className="mt-1 text-sm text-[var(--color-text-muted)]">���� ����ϸ� ��Ʈ�� �ݿ��˴ϴ�.</p>
        </div>
      ) : (
